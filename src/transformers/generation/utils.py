...
class GenerationMixin:
    ...
    def _assisted_decoding(
        ...
        **sample** (depending on `do_sample`), assisted by candidate sequences. Assisted generation is an example of a
        ...
        #timing["init"] = time.time() - start_time
        step = 0
        accept_length_list = []
        this_peer_finished = False
        ...
        while self._has_unfinished_sequences(this_peer_finished, synced_gpus, device=input_ids.device):
            ...
            #timing["get_candidates"] += time.time() - start_time
            ...
            #timing["model_forward"] += time.time() - start_time
            ...
            #timing["logits_processing"] += time.time() - start_time
            ...
            #timing["token_selection"] += time.time() - start_time
            ...
            #timing["state_updates"] += time.time() - start_time
            ...
            #timing["output_processing"] += time.time() - start_time
